...
const ServicesPage = ({ siteUrl }) => {
  ...
  const services = [
    { id: 1, name: 'Dinner Companion', category: 'premium', duration: '4 hours', rating: 4.9, image: '/assets/romantic-companion-udaipur-escort.jpg', description: 'Perfect companion for business dinners, social events, or romantic evenings.', features: ['Fine dining experience', 'Intelligent conversation', 'Elegant presentation'] },
    { id: 2, name: 'Travel Companion', category: 'vip', duration: '24 hours', rating: 4.8, image: '/assets/udaipur-escort-companion.jpg', description: 'Sophisticated travel companion for business trips or leisure vacations.', features: ['Travel arrangements', 'Cultural knowledge', 'Professional demeanor'] },
    { id: 3, name: 'Event Escort', category: 'premium', duration: '6 hours', rating: 4.9, image: '/assets/classy-escort-service-udaipur.jpg', description: 'Stunning companion for corporate events, galas, and social gatherings.', features: ['Event expertise', 'Social skills', 'Professional networking'] },
    { id: 4, name: 'VIP Experience', category: 'vip', duration: '8 hours', rating: 5.0, image: '/assets/rich-luxury-escort-udaipur.jpg', description: 'Exclusive VIP experience with premium amenities and personalized service.', features: ['Luxury venues', 'Premium service', 'Exclusive access'] },
    { id: 5, name: 'Elite Companion', category: 'elite', duration: '12 hours', rating: 5.0, image: '/assets/elite-call-girl-service-udaipur.jpg', description: 'Elite-level companionship for the most discerning clients.', features: ['Highest caliber', 'Multilingual', 'International experience'] },
    { id: 6, name: 'Weekend Getaway', category: 'elite', duration: '48 hours', rating: 5.0, image: '/assets/private-call-girls-udaipur.jpg', description: 'Complete weekend experience at luxury resorts and destinations.', features: ['Resort bookings', 'Activity planning', 'Complete package'] }
  ];
